    ...
    <div className="pt-[4.5rem] lg:pt-[5rem]">
      ...
      <section className="relative bg-gradient-to-br from-graphite-900 via-graphite-800 to-graphite-900 py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4">Mining <span className="text-brand-400">Solutions</span></h1>
          <p className="text-lg text-steel-300 max-w-2xl mx-auto leading-relaxed">From wear protection to digital infrastructure, we provide comprehensive mining solutions that address every challenge across the mining value chain.</p>
        </div>
      </section>
      ...
      <section className="relative pt-6 pb-14 bg-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <h2 className="text-3xl font-bold text-graphite-900 mb-3">9 Integrated <span className="text-brand-500">Service Lines</span></h2>
            <p className="text-steel-500 leading-relaxed text-sm">Each service line works independently or as part of an integrated solution tailored to your operation.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {solutions.map((sol, idx) => (
              <Link key={idx} to={`/services/${sol.slug}`} className="group p-5 rounded-2xl bg-graphite-50 border border-steel-200 hover:border-brand-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
                ...
                <p className="text-sm text-steel-500 leading-relaxed mb-3">{sol.description}</p>
      ...
      <section className="relative py-14 bg-gradient-to-br from-graphite-900 via-graphite-800 to-graphite-900 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">Need a Tailored Mining Solution?</h2>
          <p className="text-sm text-steel-300 mb-6 max-w-xl mx-auto">Our team is ready to discuss your requirements and develop a solution that delivers results.</p>
