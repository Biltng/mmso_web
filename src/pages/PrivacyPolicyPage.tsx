              ...
              <div className="bg-graphite-50 rounded-2xl p-6 border border-steel-200 sticky top-28">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-steel-500">Website use and linked content remain at the user’s own risk.</p>
                  </div>
                </div>
            ...
            <div className="lg:col-span-3 space-y-5">
              <div className="rounded-2xl border border-steel-200 bg-graphite-50 p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-xl font-bold text-graphite-900">Privacy and Website Use</h2>
                </div>
              ...
              <div className="rounded-2xl border border-steel-200 bg-white p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-xl font-bold text-graphite-900">External Links</h2>
                </div>
